...
[GitHub Releases sayfasını aç](https://github.com/Relactive55/wakfu-turkiye-yama-calismasi/releases/latest)

Yalnızca ilgili Release sayfasındaki doğrulanmış varlıkları kullanın. Eski
kurulum EXE'leri yeni kurulum düzeltmelerini içeriyor kabul edilmez; yeni bir
EXE yayımlandığında kendi sürümüyle birlikte aynı GitHub Release altında
belirtilecektir.
...
1. Kullandığınız yama sürümünün GitHub Release sayfasını açın ve yalnızca o
   sürümle birlikte yayımlanan doğrulanmış kurulum varlığını indirin.
...
- **Kurulum aracı:** Release sayfasında sürümü açıkça belirtilen doğrulanmış EXE
  (eski EXE'ler güncel kabul edilmez)
- **Kararlı Türkçe Yama:** tr-2026.09.09.1
...
Güncel yama varlıklarını projenin GitHub Releases sayfasından indirebilirsiniz.
